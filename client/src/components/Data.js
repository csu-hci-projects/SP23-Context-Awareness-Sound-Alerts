        ...
        if(props.context.debug){
            return(
                <div className={"data debug-alert-sound"}>
                    ...
                    <p>Brand: {props.subject.brand ? props.subject.brand : null}</p>
                    <p>Phone on silent: {props.subject.silent ? props.subject.silent : null}</p>
                    <p>Uses default notification: {props.subject.defaultNotification ? props.subject.defaultNotification : null }</p>
